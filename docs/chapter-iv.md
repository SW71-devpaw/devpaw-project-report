...
![Context](https://i.postimg.cc/VsXnwNrP/structurizr-u-Pet-System-Context.png)
...
![Container](https://i.postimg.cc/6qxmzshZ/structurizr-Containers-upet.png)


#### 4.1.3.4. Software Architecture Deployment Diagrams.
![Container](https://i.postimg.cc/XqQHCDp9/deployment-diagram.png)
...
![Veterinary Clinic Context code Level Diagrams](https://i.postimg.cc/WzHmjRdY/Veterinary-Clinic-level-diagram.png)


##### 4.2.2.6.1. Bounded Context Domain Layer Class Diagrams
Class diagrams for the domain layer of the Veterinary Clinic Context.

![Veterinary Clinic Context database diagram](https://i.postimg.cc/rmgCnRMk/Veterinary-Clinic-class-diagram.png)

##### 4.2.2.6.2. Bounded Context Database Design Diagram
Database design diagram for the Veterinary Clinic Context.

![Veterinary Clinic Context database diagram](https://i.postimg.cc/3NRjPrxD/Veterinary-Clinic-database-diagram.png)
...
![Medical Management code Level Diagrams](https://i.postimg.cc/t41SskyV/Medical-Management-level-diagram.png)

##### 4.2.3.6.1. Bounded Context Domain Layer Class Diagrams
Class diagrams for the domain layer of the Medical Management Context.
![Medical Management Context class diagram](https://i.postimg.cc/9FQNhVnb/Medical-Management-class-diagram.png)

##### 4.2.3.6.2. Bounded Context Database Design Diagram
Database design diagram for the Medical Management Context.
![Medical Management Context data base diagram](https://i.postimg.cc/CLrrMXyg/Medical-Management-database-diagram.png)
...
![User Experience Context Code Level Diagrams](https://i.postimg.cc/d1JjjjM6/User-Experience-level-diagram.png)
##### 4.2.4.6.1. Bounded Context Domain Layer Class Diagrams
Class diagrams for the domain layer of the User Experience Context.
![User Experience Context data base diagram](https://i.postimg.cc/Pqs4Pk2B/User-Experience-class-diagram.png)

##### 4.2.4.6.2. Bounded Context Database Design Diagram
Database design diagram for the User Experience Context.

![User Experience Context data base diagram](https://i.postimg.cc/nL41mwWM/User-Experience-database-diagram.png)
